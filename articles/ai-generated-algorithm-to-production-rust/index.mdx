...
date: 2026-02-10
image: ./main.jpg
imageAlt: "Abstract illustration of loose prototype modules converging into one machined block, representing an AI-generated design hardened into production Rust"
---
...
Our first implementation used the sha 256 of the mask image produced by our diffing library. Same mask, same sha, same change. Simple and correct. The way those masks are computed is described in our [diff algorithm documentation](https://argos-ci.com/docs/learn/platform-fundamentals/how-argos-detects-visual-differences#the-diff-algorithm).
