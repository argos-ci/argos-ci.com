...
date: 2024-01-25
image: ./main.jpg
imageAlt: "Abstract illustration of a mobile screen with its status bar covered by a masking band"
---
...
Integrating this feature into your existing [WebDriverIO setup](https://argos-ci.com/docs/quickstart/webdriverio-quickstart) is simple. A few lines of code enable this powerful tool, greatly enhancing your mobile visual testing process.
...
To know more, you can read the [Argos WebdriverIO SDK doc](https://argos-ci.com/docs/quickstart/webdriverio-quickstart).
