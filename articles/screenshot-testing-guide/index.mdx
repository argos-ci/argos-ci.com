...
4. Reviewers approve or reject diffs in the Argos UI (with [comments and threads](/review) for anything ambiguous). Approval flips the status to green and unblocks the merge.
