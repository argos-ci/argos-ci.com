...
date: 2023-12-12
image: ./main.jpg
imageAlt: "Abstract illustration of nested schema layers validated by a bracket that feeds into a visual comparison"
---
...
[Argos](https://argos-ci.com/docs) integrates with CI/CD pipelines, facilitating UI change verification within pull requests. Basically, it streamlines visual regression detection and give feedback into GitHub directly.
...
![Argos check status on GitHub pull request](/assets/articles/zod-and-argos/argos-check-status.png)

[![Zod error detected in Argos](/assets/articles/zod-and-argos/zod-error-in-argos.png)](https://app.argos-ci.com/argos-ci/snkr-shop/builds/24/67606393)
