...
date: 2026-07-09
image: ./main.jpg
imageAlt: "A passing Vitest test run fanning out into screenshots and file snapshots — README.md, output.json — that flow into an Argos side-by-side visual comparison."
---
