...
date: 2025-03-25
image: ./main.jpg
imageAlt: "Abstract illustration of misaligned ghosted screenshots being measured and resolved into one crisp aligned frame"
---
...
After investigating, we found the issue often appeared when using the [viewports feature](https://argos-ci.com/docs/learn/how-to-guides/visual-coverage/responsive-viewports) to test different screen sizes. Even in stable environments, image rendering wasn’t behaving as expected.
