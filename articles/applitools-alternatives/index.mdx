...
- **Beyond screenshots.** Argos snapshot-tests **any file**: Markdown, JSON, HTML, and more. It also hosts [PR-preview deployments](/deploy) for Storybook or any static build.
