...
- **Agent-ready by design.** The [CLI and REST API](/ai-agents) output structured JSON (`argos build get <ref> --json`, `argos review create <ref> --event approve`), so coding agents can inspect and review builds without screen-scraping a dashboard.
