...
date: 2023-01-24
image: ./main.jpg
imageAlt: "Abstract illustration of a browser, a CI module, and a comparison frame linked in one automated chain"
---
...
- [@argos-ci/cli](https://argos-ci.com/docs/sdks-reference/argos-command-line-interface-cli): easiest and fastest way to upload screenshots to the Argos.
- [@argos-ci/playwright](https://argos-ci.com/docs/sdks-reference/playwright): improve screenshot stability and expose CSS to hide content.
