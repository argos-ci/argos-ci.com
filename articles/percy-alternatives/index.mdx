...
- **[Agent-ready CLI and API](/ai-agents).** Coding agents can inspect and approve builds via structured JSON output (`argos build get <ref> --json`, `argos review create <ref> --event approve`).
