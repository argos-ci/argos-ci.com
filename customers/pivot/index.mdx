...
From day one, Pivot adopted **Argos** in the foundations of their testing strategy, building their setup on top of the native [Playwright integration](https://argos-ci.com/docs/sdks-reference/playwright).
...
Visual feedback is posted **directly on pull requests** through GitHub Checks, using the native [GitHub integration](/docs/learn/integrations/github-integration), allowing the team to review regressions in context.
