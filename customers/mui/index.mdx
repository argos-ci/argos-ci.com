...
A key capability for MUI is Argos [flaky indicator](/docs/learn/reliability-and-flakiness/flaky-test-detection). Engineers can instantly tell whether a difference is a real regression or a flaky screenshot. This allows them to take action early, fix instability at the source, and keep the visual test suite healthy over time.

![Flaky dashboard](/assets/customers/mui/flaky-detection.png)

## Built for Open Source at Scale

MUI runs a fully open source workflow with a high volume of forked pull requests from contributors around the world. Argos is deeply [integrated with GitHub](/docs/learn/integrations/github-integration) and handles forked PRs automatically, without additional configuration or manual approval steps.
