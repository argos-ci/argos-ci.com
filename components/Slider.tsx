...
export function Slider({
  ...
  return (
    ...
    >
      ...
      <SliderPrimitive.Thumb className="block h-4 w-4 rounded-full border bg-app shadow transition-colors focus:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50" />
    </SliderPrimitive.Root>
  );
}
