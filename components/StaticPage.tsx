  ...
  return (
    <div
      className={clsx(
        ...
        "prose-h1:font-accent prose-h1:font-semibold prose-h1:text-4xl prose-h1:md:text-6xl prose-h1:text-center prose-h1:text-balance",
        ...
        "wrap-break-word max-md:text-sm md:px-4",
      )}
    >
      <Container className="relative pt-14 pb-24">
        <div className="absolute inset-x-0 h-56 max-md:hidden">
          <SideBorder />
        </div>
        <div className="pointer-events-none absolute inset-x-0 top-56 bottom-0 border-x max-md:hidden" />
        {children}
      </Container>
    </div>
  );
