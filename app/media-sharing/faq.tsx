...
export const MEDIA_SHARING_QUESTIONS: FAQQuestion[] = [
    ...
    answer: (
      <>
        <p>
          ...
          the actual bytes at upload, so a file that isn&apos;t what it claims
          to be is rejected.
        </p>
      </>
    ),
  ...
  },
  {
    ...
    answer: (
      <>
        <p>
          Uploads draw on the screenshot allowance you already have, with no
          second quota. An image counts as 1 screenshot unit, a video as 25.
    ...
    answer: (
      <>
        <p>
          ...
          render the embed, so don&apos;t upload what must never be reachable by
          URL.
        </p>
      </>
    ),
