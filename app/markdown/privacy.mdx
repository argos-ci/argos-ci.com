...
The authoritative and always-current list is published in our [trust center](https://app.eu.vanta.com/argos/trust/8z3w834xz9a4snga4obms/subprocessors), which prevails over the summary above. We give customers at least thirty (30) days' notice before a new subprocessor starts processing their data, and they can object, as set out in our [Data Processing Agreement](/dpa). Subscribe to those notifications at [contact@argos-ci.com](mailto:contact@argos-ci.com).
