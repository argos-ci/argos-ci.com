...
export const PLAYWRIGHT_QUESTIONS: FAQQuestion[] = [
  {
  ...
  },
  {
    ...
    answer: (
      <p>
        ...
        <strong>*-snapshots/</strong> folders in Git. With Argos, baselines are
        selected from your Git history in the cloud, so there are no PNGs to
        commit, no merge conflicts, and no repo bloat.
      </p>
    ),
    textAnswer:
  ...
  },
  {
    ...
    answer: (
      <p>
        ...
        becomes a check you review and approve, instead of a failed test you fix
        by re-running with <strong>--update-snapshots</strong> and committing
        new images.
      </p>
    ),
    textAnswer:
...
export function FAQ() {
  return <FAQAccordion questions={PLAYWRIGHT_QUESTIONS} />;
}
