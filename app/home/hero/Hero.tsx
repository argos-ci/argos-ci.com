      ...
      <Container className="separator-b relative">
        ...
        <div className="relative flex w-full flex-col items-center gap-8 py-12 text-center md:pt-16 md:pb-16">
          ...
          <HeroComponent align="center">
            ...
            <HeroDescription>
              Agents ship more changes than anyone can check by eye. Argos
              captures what every pull request actually changed so your{" "}
              <span className="font-semibold"> team and agents</span> can
        ...
        <a
          href="https://app.argos-ci.com/argos-ci/snkr-shop/builds/7/381128991"
          target="_blank"
          className={clsx(
