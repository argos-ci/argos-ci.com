---
title: Partial re-runs in GitHub Actions for lower CI costs
...
date: 2024-06-17
image: /assets/changelogs/partial-re-runs-github-actions/partial-re-runs-github-actions.jpg
---
...
To benefit from this feature, update your SDK. If you don't use Playwright, set the [`ARGOS_PARALLEL_INDEX`](https://argos-ci.com/docs/learn/how-to-guides/ci-pipelines/parallel-testing-sharding) environment variable in your GitHub Actions workflow.
