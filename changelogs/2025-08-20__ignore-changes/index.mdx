...
Combined with our [Flaky Test Detection](https://argos-ci.com/changelogs/flaky-test-detection), this feature provides a powerful way to manage visual test noise. Especially with our "Ocurrences" stats that gives you the exact number of times a change has been seen.
