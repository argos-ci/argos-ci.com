...
Install the CLI with `npm install -D @argos-ci/cli`, then see the [CLI documentation](/docs/sdks-reference/argos-command-line-interface-cli) for authentication, commands, and examples.
