...
Introducing Storybook Story Modes in [Argos Storybook plugin](https://argos-ci.com/docs/quickstart/storybook-quickstart). With the latest release, you can define and apply multiple Storybook globals (e.g., themes, viewports, locales) as “modes,” generating separate snapshots for each mode automatically.
...
Upgrade to the latest version of [`@argos-ci/storybook`](https://www.npmjs.com/package/@argos-ci/storybook) to start testing your Storybook stories across every relevant configuration with fewer manual steps. Read the complete guide in [story modes documentation](https://argos-ci.com/docs/learn/how-to-guides/visual-coverage/storybook-story-modes).
