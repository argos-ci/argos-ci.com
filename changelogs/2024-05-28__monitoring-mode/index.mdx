...
For detailed instructions on how to use Monitoring Mode, please refer to [our documentation](https://argos-ci.com/docs/learn/platform-fundamentals/build-modes#monitoring-mode).
