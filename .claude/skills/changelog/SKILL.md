...
2. **Opening paragraph**: 1 to 3 sentences. Linear-style: establish the problem or context first, then introduce the feature in bold on first mention. Example: "Analytics used to tell you how much you tested. Now it tells you how visual testing is going."
3. **Bulleted capabilities**: 3 to 5 bullets, each starting with a **bold lead-in** naming the capability, followed by a colon and a concrete explanation. This is the scannable core of the entry.
...
Target length: 150 to 300 words. It's a changelog, not a blog post. If there's a bigger story, link to a blog article.
...
- **No em-dashes.** They read as AI-edited, so they are banned from anything we ship: entries, social posts, commit messages. Use a colon, a comma, parentheses or two sentences instead. Short sentences are house style; avoid comma-spliced walls of text.
